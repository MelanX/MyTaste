...
export default function ThemeToggle() {
  ...
  return (
    <button
      ...
      title={theme === 'light' ? 'Light mode — switch to dark' : 'Dark mode — switch to light'}
      aria-label={`Switch to ${next} mode`}
      className="flex h-9 w-9 items-center justify-center rounded-full border border-line bg-surface text-fg transition-colors hover:bg-bg-alt"
    >
