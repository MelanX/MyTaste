    ...
    <div>
      <div className={recipeStyles.titleRow}>
        {renaming ? (
          ...
          <h2 className={styles.collectionName} onClick={startRename} title="Zum Umbenennen klicken">
            {collection.name}
          </h2>
        )}
        <div className={styles.actions}>
          ...
          <div className={styles.actionsRow}>
            <button type="button" className={styles.clearButton} onClick={handleClear} disabled={collection.recipeIds.length === 0}>
              Leeren
            </button>
            <button type="button" className={styles.deleteButton} onClick={handleDelete}>
              Löschen
            </button>
            <button type="button" className={styles.backLink} onClick={() => navigate('/collections')}>
              Zurück
            </button>
          </div>
        </div>
          ...
          <div key={recipe.id} className={recipeStyles.recipeCard}>
            ...
            <div className={recipeStyles.recipeCardContent}>
              ...
              <div className={recipeStyles.recipeCardBottom}>
                ...
                <button type="button" className={styles.removeButton} onClick={() => removeRecipe(collection.id, recipe.id)}>
                  Entfernen
                </button>
              </div>
            </div>
